...
@section('content')
<div class="container" style="margin-bottom:20px; min-height: 1200px;">
    <div class="row">
            ...
            <div class="z-article-horizontal">
                <div class="row">
                    <div class="col-xs-8">
                        ...
                        <span class="z-info hidden-xs">发表于 {{ $article->created_at_date }} · 最后访问 {{ $article->updated_at_diff }}</span>
